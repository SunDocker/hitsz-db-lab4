...
import cn.edu.hitsz.entity.CheckShow;
 ...
 * @author SunDocker
 */
@WebServlet("/activity/showCheck")
public class ActivityShowCheck extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String sql = "select name, volunteer_account volunteerAccount, check_status checkStatus, signup_time signupTime, no " +
                "from participate p, volunteer_activity va " +
                "where p.activity_no = va.no and admin_account = ?";
        ...
        List<CheckShow> shows = JDBCUtil.getResSetIntoList(rs, CheckShow.class);
